      ...
      <div style="border: 2px solid rgb(185, 184, 184); padding: 70px; box-shadow: 2px 2px 4px rgb(70, 69, 69); margin-bottom: 40px;">
          ...
          <div class="form-group col-md-4">
              ...
              <textarea required name="mots" class="form-control" id="mots" rows="3"
                ...
                style="border: none; box-shadow: none; border-radius: 0; border-bottom: 1px solid; width:800px"></textarea>
          </div>
      </div>
  </div>
      ...
      <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input required type="text" class="form-control" id="lien_doc" placeholder="{{ __("Entrez un lien; ex: lien github") }}" name="lien_doc" style="border: none; box-shadow: none; border-radius: 0; border-bottom: 1px solid;" >
          </div><br>
