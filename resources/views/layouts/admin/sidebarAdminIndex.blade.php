...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        @if (Auth::user()->profil_id == 0 || Auth::user()->profil_id == 1)
            <li class="nav-item">
                ...
                <ul id="table-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a
                            href="{{ route('Ecole_Doctorat.Inscription.index') }}"@if (isset($inscription)) class="active" @endif>
            ...
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    @if (Auth::user()->profil_id == 2 || Auth::user()->profil_id == 4)
                        <li>
                            <a href="{{ route('Admin.etudiant.createFil', Auth::user()->departement_id) }}"
                                @if (isset($etudiant_c)) class="active" @endif>
                                <i class="bi bi-circle"></i><span> Ajouter un Etudiant</span>
                            </a>
                        </li>
                    @endif
        ...
        <li class="nav-item">
            <a class="nav-link @if (!isset($user_i)) collapsed @endif"
        ...
        @if (Auth::user()->profil_id == 0 || Auth::user()->profil_id == 2 || Auth::user()->profil_id == 4)
            ...
            <li class="nav-item">
                <a class="nav-link @if (!isset($utilisateur_i)) collapsed @endif "
